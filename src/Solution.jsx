...
const Solution = () => {
  return (
    ...
    <div id="solution" className="max-w-full mx-auto px-6 md:px-12 xl:px-6 dark:bg-gray-900">
        {/* <div className='h-8'></div> */}
      <div className="space-y-6 pt-8 justify-between text-gray-600 md:flex flex-row-reverse md:gap-6 md:space-y-0 lg:gap-12 lg:items-center">
